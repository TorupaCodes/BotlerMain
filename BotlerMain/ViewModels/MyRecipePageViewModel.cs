...
namespace BotlerMain.ViewModel
{
...

    {
        ...
        public MyRecipePageViewModel()
        {
            ...
            FoodList.Add(new MyRecipeModel { Name = "Biefstuk", Image = "https://img.static-rmg.be/a/food/image/q75/w640/h400/1067760/steak-met-puree-van-zoete-aardappelen-en-granaatappelpitjes.jpg", Detail = "Biefstuk met aardappelpuree en SAUS" });
            ...
            FoodList.Add(new MyRecipeModel { Name = "FruitSalada", Image = "https://www.24kitchen.nl/files/styles/300h_300w/public/2014-12/145627.original.jpg?itok=LZBk5eKx", Detail = "Heerlijk frisse zomerse fruit salade" });
